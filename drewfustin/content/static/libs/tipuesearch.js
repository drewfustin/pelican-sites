                    ...
                    if (d.length >= set.minimumLength)
                    {
                         ...
                         for (var i = 0; i < tipuesearch_in.pages.length; i++)
                         {
                              ...
                              for (var f = 0; f < d_w.length; f++)
                              {
                                   ...
                                   if (tipuesearch_in.pages[i].summary.search(pat) != -1)
                                   {
                                        score -= (180000 - i);
                                   }
                              ...
                              if (score < 1000000000)
                              {
                                   found[c++] = score + '^' + tipuesearch_in.pages[i].title + '^' + s_t + '^' + tipuesearch_in.pages[i].url + '^' + tipuesearch_in.pages[i].summary + '^' + tipuesearch_in.pages[i].image + '^' + tipuesearch_in.pages[i].date + '^' + tipuesearch_in.pages[i].locale_date;
                              }
                         }
                         ...
                         if (c != 0)
                         {
                              ...
                              for (var i = 0; i < found.length; i++)
                              {
                                   ...
                                   if (l_o >= start && l_o < set.show + start)
                                   {
                                        ...
                                        out += '<a href="' + fo[3] + '"' + tipue_search_w + '><img src="' + fo[5] + '"></a>';
                                        out += '<header><a href="' + fo[3] + '"' + tipue_search_w + '>' + fo[1] + '</a></header>';
                                        out += '<time datetime="' + fo[6] + '">' + fo[7] + '</time>';
                                        out += fo[4];
                                        if (set.showURL)
                                        {
