...
class Tipue_Search_JSON_Generator(object):
    ...
    def __init__(self, context, settings, path, theme, output_path, *null):
        ...
        self.output_path = output_path
        self.json_nodes = []
        self.default_image = settings.get('DEFAULT_IMAGE')
    ...
    def create_json_node(self, page):
        ...
        page_date = page.date.isoformat() if str(getattr(page, 'date', 'None')) != 'None' else ''
        page_locale_date = page.locale_date if getattr(page, 'locale_date', 'None') != 'None' else ''
        ...
        page_image = page.featured_image if getattr(page, 'featured_image', 'None') != 'None' else self.default_image
